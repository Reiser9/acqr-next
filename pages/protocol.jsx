...
const Protocol = () => {
    React.useEffect(() => {
        const rotate = () => {
            let scroll = $(".mission__text--inner").offset().top;
            let sc = $(window).scrollTop();
            let heightBlock = $(".mission__text--inner").height();

            if (sc - scroll > -320 && sc - scroll <= heightBlock - 295) {
                $(".mission__progress").css("height", sc - scroll + 300 + "px");
            } else if (sc - scroll > -320) {
                $(".mission__progress").css("height", "100%");
            }

            if (sc + 320 > scroll) {
                let blocks = $(".mission__item");

                blocks.each(function () {
                    if ($(this).offset().top < sc + 300) {
                ...
                <div className="container">
                    <div className="help__inner">
                        ...
                        <h2 className="help__title">
                            ...
                            <span className="gradient3">Growth</span> For Your
                            Web3 Protocol.
                        </h2>

                        <p className="mission__text">
                            ACQR is an on-chain platform that provides you with
                            effective marketing and user acquisition tools from
                ...
                <div className="container">
                    <div className="here__inner">
                        ...
                        <p className="here__text">
                            Web2 marketing is difficult for web3 protocols. Most
                            web3 protocols fail because they cannot acquire
                            enough users and implement new marketing strategies.
                            ACQR combines the best of both worlds to provide
                            protocols with unmatched tools for growth.
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="leading__content">
                            ...
                            <div className="leading__point">
                                <img
                                    ...
                                    className="leading__point--icon"
                                />
                                Jumpstart community growth and increase social
                                followings.
                            </div>
                ...
                <div className="container">
                    <div className="mission__inner">
                        <h2 className="mission__title">
                            Co-design a Mission with{" "}
                            <span className="gradient3">ACQR</span>
                        </h2>

                        <p className="mission__text">
                            Missions help educate and onboard more users for
                            your protocol. Missions are fully customizable to
                            fit your protocols&rsquo; needs.
                        </p>

                        <div className="mission__content">
                            <div className="mission__text--inner">
                                <div className="mission__item">
                                    <p className="mission__item--title">
                                        Determine Rewards
                                    </p>

                                    <p className="mission__item--text">
                                        Set the rewards users earn for
                                        completing a Mission (Tokens or NFTs).
                                    </p>
                                </div>
                                ...
                                <div className="mission__item">
                                    ...
                                    <p className="mission__item--text">
                                        Tell users about your amazing protocol
                                        and why users should participate in it.
                                    </p>
                                </div>
                                ...
                                <div className="mission__item">
                                    ...
                                    <p className="mission__item--text">
                                        Decide what tasks users should complete
                                ...
                                <div className="block__point--inner">
                                    ...
                                    <div className="block__point">
                                        <img
                                            ...
                                            className="block__point--icon"
                                        />
                                        Excited to educate and onboard the next
                                        wave of web3 users.
                                    </div>
                                    ...
                                    <div className="block__point">
                                        <img
                                            ...
                                            className="block__point--icon"
                                        />
                                        Have protocols that are safe and
                                        reliable.
                                    </div>
                ...
                <div className="container">
                    <div className="protocol__inner">
                        ...
                        <h2 className="protocol__title protocol__wrap">
                            Ready to grow your{" "}
                            <span className="gradient3">Web3</span> protocol?
                        </h2>
